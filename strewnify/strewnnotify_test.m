...
logformat('Strewnify Meteor Event Notification TEST service started.','INFO')
...
email_subject = 'Strewnify Automated Meteor Report TEST';
...
try
    [NewEvents, attachment, numevents] = getnew_test(numdays);    
catch
    numevents = -1;
    ErrorMsg = 'There was an error in GETNEW_TEST, check code.';
    logformat(ErrorMsg,'ERROR');
end
