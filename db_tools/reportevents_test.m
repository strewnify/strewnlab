...
fields_formatted = [{'Location:'} {'eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).Location(max(1,end-colwidth+3):end)'};...
    {'Date:'} {'datestr(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).Datetime,''mm/dd/yyyy'')'};...
    {'Time:'} {'datestr(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).Datetime,''HH:MM:ss UTC'')'};...
    ...
    {'Speed:'} {'[num2str(round(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).entry_Speed_kps,2)) '' km/s'']'};...
    {'Bearing:'} {'[num2str(round(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).ref_Bearing_deg,1)) 176 ''('' compassdir(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).ref_Bearing_deg) '')'']'};...
    {'Slope:'} {'[num2str(round(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).ref_ZenithAngle_deg,1)) 176 '' from vertical'']'};...
    {'Altitude:'} {'[num2str(round(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).ref_Altitude_km,2)) '' km'']'};...
    {'Energy Est:'} {'[num2str(round(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).ImpactEnergyEst_kt,2)) '' kt'']'};...
    {'Mass:'} {'[num2str(round(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).entry_Mass_kg,2)) '' kg'']'};...
    {'Report count:'} {'num2str(eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).NumReports)'};...
    {'Source Key:'} {'eventdatabase.(EventIDs{event_i}).Trajectory.(Sources{source_i})(record_i).SourceKey{1}'};...
