function [position_pct] = pctHorFOV(minAZ, maxAZ, testAZ)
% pctHorFOV Determine if an azimuth is visible to a camera and what position in the frame
% [position_pct] = pctHorFOV(minAZ, maxAZ, testAZ)  Calculate the position of
