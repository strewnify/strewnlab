...
ARCLEN = (360 * norm([startposition(1),startposition(2)]))/(2 * pi * earthradius); % distance in degrees of arc
...
ARCLEN = (360 * norm([endposition(1),endposition(2)]))/(2 * pi * earthradius); % distance in degrees of arc
endlocation = reckon(nom_lat, nom_long, ARCLEN, AZ); 
ARCLEN = (360 * norm([darkposition(1),darkposition(2)]))/(2 * pi * earthradius); % distance in degrees of arc
...
nom_ARCLEN = (360 * norm([nom_startposition(1),nom_startposition(2)]))/(2 * pi * earthradius); % distance in degrees of arc
...
nom_ARCLEN = (360 * norm([nom_endposition(1),nom_endposition(2)]))/(2 * pi * earthradius); % distance in degrees of arc
nom_endlocation = reckon(nom_lat, nom_long, nom_ARCLEN, nom_AZ); 
nom_ARCLEN = (360 * norm([nom_darkposition(1),nom_darkposition(2)]))/(2 * pi * earthradius); % distance in degrees of arc
