function P_d = NEXRAD_detection_probability(object_area_m2, slantRange_m)
    % calculate_detection_probability calculates the probability of detection for an object in a radar beam.
    %
    % Inputs:
    ...
    % Calculate the detection probability using the SNR threshold (assuming typical SNR threshold for detection)
    detection_threshold_dB = 6; % Example threshold (you can adjust this based on your radar system)
